...
import { CodeBlockWrapper } from '@/widgets/code-block-wrapper';
import { CopyButton } from '@/widgets/copy-button';
import { StyleWrapper } from '@/widgets/style-wrapper';
  ...
  pre: ({
    ...
    return (
      <StyleWrapper styleName={__style__}>
        <pre
          className={cn(
            'mb-4 mt-6 max-h-[650px] overflow-x-auto rounded-lg border bg-zinc-950/90 py-4 dark:bg-white/10',
            className
          )}
          {...props}
        />
